      ...
      $.ajax({
          ...
          success: function(respuesta) {
                if(respuesta){
                  ...
                  $('#message').append('<div class="alert alert-danger contenidoMensaje"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>Los parámetros no se han podido guardar correctamente</div>');
                  $('.contenidoMensaje').fadeOut(3000);
                }
             }
      })
